  ...
  return (
    <Wrapper>
      ...
      <ProfileContainer id="profile">
        <About id="about">
          <PhotoInner><Image src="/photo-trimmed.jpg" height="186" width="153" alt="" /></PhotoInner>
          <h3>God is also a programmer, see the bugs around!</h3>
          <h1>- RAVI GYANI</h1>
          <p>Currently dabbling in AWS, Cloud, BigData, Hadoop, Kafka, Spark, NoSQL DBs, Godot</p>
        </About>
      ...
      <ArticlesContainer id="documentation">
